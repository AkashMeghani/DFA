...
def main():
    ...
    try:
        for target in targets_list:
            ...
            print("Checking for target read_only")
            if not target.get('read_only'):
                ...
                elif target['read_only'] == 'False':
                    target['read_only'] = False
            
            # reset_dc as bool
            print("Checking for target reset_dc")
            ...
            print("target_type", target['device_type'], target)
            ...
            print("checking if ob logged in")
            ...
            print("if connection not established")
            if ro_json['ConnectionState'] != 'Connected':
                return_code = 1
